...
@dataclass
class AudioPretrainingPseudoLanguageConfig(AudioPretrainingConfig):
    ...
    # added in the pseudo language project
    label_dir: Optional[str] = field(
        default=None, metadata={"help": "folder contains label data"}
    )
