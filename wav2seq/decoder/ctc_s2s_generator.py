...
from fairseq.sequence_generator import EnsembleModel, EnsembleModelWithAlignment

from .ctc_decoder import BatchCTCPrefixScore


# modified from SequenceGenerator
class CTCSeq2seqGenerator(nn.Module):
    def __init__(
        self,
        models,
        tgt_dict,
